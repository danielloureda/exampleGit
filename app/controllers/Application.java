...
public class Application extends Controller {
	...
	public static Result getPersons() {
		...
		if (persons == null) {
			persons = new Model.Finder<String, Person>(String.class, Person.class).all();
	...
	private static void sendMail(Person person) {
		...
		// adds attachment
		// mail.addAttachment("attachment.pdf", new
		// File("/some/path/attachment.pdf"));
		// adds inline attachment from byte array
		// byte[] data = "data".getBytes();
		// mail.addAttachment("data.txt", data, "text/plain", "A simple file",
